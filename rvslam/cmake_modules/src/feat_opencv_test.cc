...
DEFINE_int32(reduce_size, 1, "reduce size 1/n");
...
int main(int argc, char **argv) {
  ...
  */
  ...
  //FastBrief
  feat.DetectFastBriefFrame(FLAGS_image_files, 0,
                            FLAGS_reduce_size,
                            &keypoint, &descriptor);
  feat.DetectFastBriefFrame(FLAGS_image_files, 1,
                            FLAGS_reduce_size,
                            &keypoint2, &descriptor2);
  keypoints.clear();
  descriptors.clear();
  ...
  descriptors.push_back(descriptor2);
  feat.MatchingTest(FLAGS_image_files, FLAGS_reduce_size, keypoints,
                    descriptors, 0, 1, "FastBrief_FRAME");
  ...
  */
  ...
  //FastBrief
  feat.DetectFastBrief(FLAGS_image_files, FLAGS_start, FLAGS_end,
                       FLAGS_reduce_size,
                       &keypoints, &descriptors);
  feat.MatchingTest(FLAGS_image_files, FLAGS_reduce_size, keypoints,
                    descriptors, 0, 1, "FastBrief");
