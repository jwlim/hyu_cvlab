...
bool LoopClosing::ComputeSim3(Keyframe& cur_kf,
                              vector<Keyframe>& keyframes,
                              const map<int, Vec3>& ftid_pts_map) {
  ProfileBegin("42.ComputeSim3", &pdb_);
  ...
  ProfileEnd("42.ComputeSim3", &pdb_);
  return true;
}
...
bool LoopClosing::DetectLoop(Keyframe& cur_kf, vector<Keyframe>& keyframes) {
  ProfileBegin("41.DetectLoop", &pdb_);
...
bool LoopClosing::CorrectLoop(Keyframe& cur_kf,
                              vector<Keyframe>& keyframes,
                              map<int, Vec3>& ftid_pts_map) {
  ProfileBegin("43.CorrectLoop", &pdb_);
  int matching_th = FLAGS_loop_th;
  //Update Covisible graph
  ProfileBegin("431.UpdateCovisible", &pdb_);
  for (int i = 0; i < keyframes.size(); ++i) {
  ...
  ProfileEnd("431.UpdateCovisible", &pdb_);
  ...
  ProfileBegin("432.MergeLandmarks", &pdb_);
  ...
  ProfileEnd("432.MergeLandmarks", &pdb_);
  ...
  ProfileBegin("433.Optimization", &pdb_);
  PoseGraphOptimization(keyframes,
                        ftid_pts_map,
                        loopconnections,
                        noncorrectedsim3,
                        correctedsim3);
  ProfileEnd("433.Optimization", &pdb_);
  ProfileEnd("43.CorrectLoop", &pdb_);
  return true;
}
...
void LoopClosing::PoseGraphOptimization(vector<Keyframe>& keyframes,
  ...
  ProfileBegin("4331.Modeling", &pdb_);
  //Modeling
  ...
  ProfileEnd("4331.Modeling", &pdb_);
  // Solving
  ProfileBegin("4332.Solving", &pdb_);
  ...
  ProfileBegin("4332.Refine3D", &pdb_);
